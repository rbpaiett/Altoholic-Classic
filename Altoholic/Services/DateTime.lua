...
addon:Service("AltoholicUI.DateTime", function()
	...
	service.GetMonthInfo = function(offset, monthOffset)
			...
			-- 2026 Fix: Use Server Weekday (1=Sun, 7=Sat) minus 1 to match 0-index logic
            local serverTime = C_DateAndTime.GetCurrentCalendarTime()
            local dayOfWeek = (serverTime.weekday - 1) + daysDiff
